      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-2">
        ...
        <div>
          <div className="rounded-xl border border-[var(--frame)] bg-black/30 p-8 text-center">
            ...
            <p
              className="mt-2 font-display text-6xl text-[var(--safelight)]"
              aria-live="polite"
            >
              {rating.toFixed(1)}
            </p>
          ...
          <ul className="flex flex-col gap-2">
            {factors.map((f) => (
              <li
                key={f.label}
                className="flex items-center justify-between rounded-lg border border-[var(--frame)] px-4 py-2 text-sm"
              >
