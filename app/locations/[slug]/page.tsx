    ...
    <article>
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {location.genres.map((g) => (
          <span key={g} className="rounded-full bg-neutral-800 px-3 py-1 text-sm text-amber-400">
            {g}
          </span>
        ))}
      </div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border border-neutral-800 p-5">
          ...
          <p className="mt-1 font-semibold">{location.best_time.replace("_", " ")}</p>
        </div>
        <div className="rounded-xl border border-neutral-800 p-5">
        ...
        <div className="rounded-xl border border-neutral-800 p-5">
          <p className="text-xs uppercase text-neutral-500">Avg session rating</p>
          <p className="mt-1 font-semibold text-amber-400">
            {avgRating.toFixed(1)} / 10
          </p>
        </div>
        <div className="rounded-xl border border-neutral-800 p-5">
          <p className="text-xs uppercase text-neutral-500">Recorded sessions</p>
